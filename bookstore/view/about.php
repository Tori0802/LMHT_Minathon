...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel" stl style="margin-bottom: 50px;">
  <div class="carousel-inner" height = 90%>
    <div class="carousel-item active" data-bs-interval="2000">
      <img src="/bookstore/asset/img/about3.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="/bookstore/asset/img/about1.png" class="d-block w-100" alt="...">
    </div>
  </div>
      ...
      <div class="container">
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-8" style="margin-bottom:20px;">
              <img src="/bookstore/asset/img/about1.png" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
